...
window.addEventListener('load', function() {
    ...
    var serviceIitemText3 = "Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.";
    var serviceIitemTextArr = [serviceIitemText0, serviceIitemText1, serviceIitemText2, serviceIitemText3];
    ...
    var getNowButton = document.querySelector(".get-now");

    var portfolioMenuBtns = document.querySelectorAll(".portfolio-menu-btn");
    var portfolioContainer = document.querySelector(".portfolio-cont");
    var portfolioIconCounters = document.querySelectorAll(".portfolio-icon-counter");
    ...
    var inputSubmitBtn = document.querySelector(".input-submit-btn");
    ...
    function sectionServicesHandler() {
        /*scrollY
        this.offsetTop
    ...
    // sectionServices.addEventListener('click', sectionServicesHandler); // TEST
    ...
    function activeServiceHandler(event){
        ...
        var serviceItemText = document.querySelector(".service-item-text");
    ...
    for (var i = 0; i < portfolioMenuBtns.length; i++ ) {
        portfolioMenuBtns[i].addEventListener('click', portfolioMenuHandler);
    }

    var portfolioIconCounterBusyFlag = false;

    function portfolioIconCounterHandler() {

        if (portfolioIconCounterBusyFlag == false) {
    ...
    for (var i = 0; i < aboutIconSocialBtns.length; i++ ) {
